class ArticleEntity {
  ...
  ArticleEntity.fromJson(Map<dynamic, dynamic> json){
...
class ArticleData {
  ...
  ArticleData.fromJson(Map<dynamic, dynamic> json){
    over = json['over'];
    ...
    if (json['datas'] != null){
    datas = [];
      (json['datas'] as List).forEach((v) {datas?.add(new ArticleDataData.fromJson(v)) ;});
    }
